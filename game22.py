...
def main(app, multiplayer = False, net = None, host = False, players = None, self_name = None, difficulty = "NORMAL", draw_los = True, dev_tools = True, skip_intervals = False, map = None):
    ...
    diff_rates = {"NO ENEMIES" : [0,1,1,1, -1], "SUPER EASY" : [0.1,0.9,0.75,1, 1.2],"EASY" : [0,0.9,0.75,1, 1.2], "NORMAL" : [1,1,1,1,6], "HARD" : [1.25, 1.25, 1.1, 0.85, 10], "ONSLAUGHT" : [1.5, 1.35, 1.2, 0.7, 14]} #
