class Menu:
    def __init__(self,buttons=None,background=None,checkboxes=None,clock=None,screen=None,terminal1=None,terminal2=None,particle_list=None):
    ...
    def update(self, state):
        ...
        if   self.menu_state=="start"               :self.start_menu(              state)
        elif self.menu_state=="settings"            :self.settings_menu(           state)
        elif self.menu_state=="mp_start"            :self.multiplayer_start_menu(  state)
